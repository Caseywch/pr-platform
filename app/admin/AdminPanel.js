    ...
    <div className="flex flex-col gap-4">
      <div className={card}>
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          <input className={input} placeholder="Project name (max 18 characters)" value={name} maxLength={18} onChange={(e) => setName(e.target.value)} />
...
function ListTab({ supabase, table, items, setItems, label, fail, maxLength }) {
  const [name, setName] = useState("");
    ...
    <div className={card}>
      ...
      <div className="flex gap-2 mb-3">
        <input
          ...
          placeholder={`Add a ${label.toLowerCase()}${maxLength ? ` (max ${maxLength} characters)` : ""}`}
          value={name}
          maxLength={maxLength}
