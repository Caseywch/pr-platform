...
// Shared recipient set for both a change-request submission and the
// resulting decision (approve/reject) — Requester (they raised it), the
// specific Verifier and Approver who verified/approved this PR (role
// fallback if that stage hasn't happened), and everyone currently holding
// Purchasing on the project (they're the one who actually decides it).
