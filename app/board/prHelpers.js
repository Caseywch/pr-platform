...
// who that is. Covers every status that's genuinely waiting on a role
// (Verification, Approval, Issue PO, Log delivery); returns "" for anything
// else (fulfilled, cancelled, rejected — nobody's holding those up via a
// project role). If nobody currently holds the relevant role on the
// project, returns "" rather than showing an empty dash.
